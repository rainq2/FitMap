...
public class Training_core extends AppCompatActivity {
    TextView root_core_View;
    private Button btn_edit,btn_delete_core;
    ...
    public void cal_Onclick(View view) {
        ...
        intent.setClass(Training_core.this, Training_coreedit.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.training_core);

        root_core_View = findViewById(R.id.textView128);

        createNotificationChannel(); // 創建通知頻道

        fetchDataAndUpdate();

        btn_edit =findViewById(R.id.button94);
        ...
        btn_delete_core =findViewById(R.id.button105);
        btn_delete_core.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(Training_core.this, edit_core_menu.class);
                startActivity(intent);
            }
        });
        ...
        Ibtn1 = findViewById(R.id.imageButton73);
        Ibtn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_core.this, Reservation1.class);
                startActivity(intent);
            }
        });

        Ibtn2 = findViewById(R.id.imageButton76);
        Ibtn2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                //intent.setClass(Training.this, Running.class);
                intent.setClass(Training_core.this, RunningDemo3.class);
                startActivity(intent);
            }
        });

        Ibtn3 = findViewById(R.id.imageButton77);
        Ibtn3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_core.this, Home.class);
                startActivity(intent);
            }
        });

        Ibtn4 = findViewById(R.id.imageButton78);
        Ibtn4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_core.this, Training.class);
                startActivity(intent);
            }
        });

        Ibtn5 = findViewById(R.id.imageButton79);
        Ibtn5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_core.this, Article_food.class);
                startActivity(intent);
            }
        });
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (!result.isEmpty()) {
                ...
                root_core_View.setText(dataText.toString());
                //showNotification("更新資料", "資料已更新"); // 顯示通知
            } else {
                root_core_View.setText("取得資料失敗");
            }
        }
    }
