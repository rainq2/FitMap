...
public class Training_arms extends AppCompatActivity {
    TextView root_arms_View;
    private Button btn_edit, btn_delete_arms;
    ...
    public void cal_Onclick(View view) {
        ...
        intent.setClass(Training_arms.this, Training_armsedit.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trainging_arms);

        root_arms_View = findViewById(R.id.textView106);

        createNotificationChannel(); // 創建通知頻道

        fetchDataAndUpdate();

        btn_edit =findViewById(R.id.button86);
        ...
        btn_delete_arms =findViewById(R.id.button102);
        btn_delete_arms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(Training_arms.this, edit_arms_menu.class);
                startActivity(intent);
            }
        });
        ...
        Ibtn1 = findViewById(R.id.imageButton65);
        Ibtn1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_arms.this, Reservation1.class);
                startActivity(intent);
            }
        });

        Ibtn2 = findViewById(R.id.imageButton66);
        Ibtn2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                //intent.setClass(Training.this, Running.class);
                intent.setClass(Training_arms.this, RunningDemo3.class);
                startActivity(intent);
            }
        });

        Ibtn3 = findViewById(R.id.imageButton67);
        Ibtn3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_arms.this, Home.class);
                startActivity(intent);
            }
        });

        Ibtn4 = findViewById(R.id.imageButton68);
        Ibtn4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_arms.this, Training.class);
                startActivity(intent);
            }
        });

        Ibtn5 = findViewById(R.id.imageButton69);
        Ibtn5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Training_arms.this, Article_food.class);
                startActivity(intent);
            }
        });
    ...
    private void fetchDataAndUpdate() {
        fetchDataRunnable = new Runnable() {
            @Override
            public void run() {
                new Training_arms.FetchDataTask().execute();
    ...
    private class FetchDataTask extends AsyncTask<Void, Void, ArrayList<String>> {
        ...
        protected void onPostExecute(ArrayList<String> result) {
            if (!result.isEmpty()) {
                ...
                root_arms_View.setText(dataText.toString());
                //showNotification("更新資料", "資料已更新"); // 顯示通知
            } else {
                root_arms_View.setText("取得資料失敗");
            }
        }
    }
